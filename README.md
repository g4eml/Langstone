...
- Edit the config.txt file and add the lines lcd_rotate=2 and disable_splash=1

- Edit the cmdline.txt file change tty1 to tty3 and add the following to the end....  vt.global_cursor_default=0 

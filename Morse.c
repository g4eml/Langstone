...
unsigned long morseLetters[26] = {0x001D,0x0157,0x05D7,0x0057,0x0001,0x0175,0x0177,0x0055,0x0005,0x1DDD,0x01D7,0x015D,0x0077,0x0017,0x0777,0x05DD,0x1D77,0x005D,0x0015,0x0007,0x0075,0x01D5,0x01DD,0x0757,0x1D77,0x0577};
